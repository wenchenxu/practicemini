...
exports.main = async (event, context) => {
  ...
  try {
    ...
    const dataForDocx = {
      ...
      rentMonthlyThirdYear: finalFields.rentMonthlyThirdYear,
      rentMonthlyThirdYearFormal: finalFields.rentMonthlyThirdYearFormal,
      rentMonthlyFourthYear: finalFields.rentMonthlyFourthYear,
      rentMonthlyFourthYearFormal: finalFields.rentMonthlyFourthYearFormal,
      rentMonthlyFifthYear: finalFields.rentMonthlyFifthYear,
      rentMonthlyFifthYearFormal: finalFields.rentMonthlyFifthYearFormal,
      rentMonthlySixthYear: finalFields.rentMonthlySixthYear,
      rentMonthlySixthYearFormal: finalFields.rentMonthlySixthYearFormal,
      thirdYearOnwardsRents: finalFields.thirdYearOnwardsRents,
