...
Page({
  ...
  onRenew() {
    ...
    wx.navigateTo({
      url: `/pages/contract/contract-new/index?id=${contract._id}&cityCode=${encodeURIComponent(contract.cityCode)}&city=${encodeURIComponent(contract.cityName)}&branchCode=${encodeURIComponent(contract.branchCode || '')}&branchName=${encodeURIComponent(contract.branchName || '')}&mode=renew`
    });
  },
