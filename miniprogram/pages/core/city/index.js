...
Page({
    ...
    goNew() {
        ...
        let url = `/pages/contract/contract-new/index?cityCode=${encodeURIComponent(cityCode)}&city=${encodeURIComponent(city)}&mode=create`;
    ...
    goOffline() {
        const { cityCode, city, branchCode, branchName } = this.data;
        let url = `/pages/contract/contract-new-offline/index?cityCode=${encodeURIComponent(cityCode)}&city=${encodeURIComponent(city)}`;
        if (branchCode) url += `&branchCode=${branchCode}&branchName=${encodeURIComponent(branchName)}`;
    ...
    goList() {
        const { cityCode, city, branchCode, branchName } = this.data;
        let url = `/pages/contract/contract-list/index?cityCode=${encodeURIComponent(cityCode)}&city=${encodeURIComponent(city)}`;
        if (branchCode) url += `&branchCode=${branchCode}&branchName=${encodeURIComponent(branchName)}`;
    ...
    onGoDriverCenter() {
        ...
        let url = `/pages/driver/driver-center/index?cityCode=${encodeURIComponent(cityCode)}&cityName=${encodeURIComponent(city)}`;
        if (branchCode) url += `&branchCode=${branchCode}&branchName=${encodeURIComponent(branchName)}`;
    ...
    toVehicleCenter() {
        const { cityCode, city, branchCode, branchName } = this.data;
        let url = `/pages/vehicle/vehicle-center/index?cityCode=${cityCode}&city=${city}`;
        if (branchCode) url += `&branchCode=${branchCode}&branchName=${encodeURIComponent(branchName)}`;
