// miniprogram/pages/vehicle/vehicle-center/index.js
...
Page({
  ...
  toDetail(e) {
    ...
    wx.navigateTo({
      url: `/pages/vehicle/vehicle-detail/index?id=${id}&city=${encodeURIComponent(city)}&cityCode=${encodeURIComponent(cityCode)}`
    });
  },
